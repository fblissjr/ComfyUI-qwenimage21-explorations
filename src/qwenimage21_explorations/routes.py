"""Routes a front end calls on ComfyUI: heylook lookups, and input thumbnails.
...
request and never resizes, so a picker over a few hundred inputs pulled tens
of kilobytes and a full-size encode per tile. `/qwenimage21/thumb` answers a
